...
#define GAME_COLOR_GOLD_METALLIC    0xFFD4AF37  // メタリックゴールド

#define GAME_COLOR_GOLD_DEEP        0xFFE6B800  // ディープゴールド

#define GAME_COLOR_GOLD_LIGHT       0xFFF5D76E  // ライトゴールド

#define GAME_COLOR_GOLD_ANTIQUE     0xFFC5A059  // アンティークゴールド
