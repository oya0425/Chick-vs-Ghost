...
namespace
{
    ...
    constexpr float Offscreen = -1000;
}
...
void EnemyPool::DrawBossDebugInfo()
{
    ...
    m_ImageSlash->setPos(Offscreen, Offscreen);
    // Aボタン
    m_ImageA->setRenderEnable(false);
    m_ImageA->setPos(Offscreen, Offscreen);

    // Dボタン
    m_ImageD->setRenderEnable(false);
    m_ImageD->setPos(Offscreen, Offscreen);
